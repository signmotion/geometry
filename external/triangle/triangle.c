...
/**
Описание POLY-файла > http://people.sc.fsu.edu/~jburkardt/data/poly/poly.html
*/


/**
@source http://www.fluvial.ch/m/Triangle_help.html
...
typedef real_t **triangle;            /* Really:  typedef triangle *triangle   */
...
typedef real_t **subseg;                  /* Really:  typedef subseg *subseg   */
...
struct badtriang {
  ...
  real_t key;                             /* cos^2 of smallest (apical) angle. */
...
struct event {
  real_t xkey, ykey;                              /* Coordinates of the event. */
...
real_t splitter;       /* Used to split real_t factors for exact multiplication. */
real_t epsilon;                             /* Floating-point machine epsilon. */
real_t resulterrbound;
real_t ccwerrboundA, ccwerrboundB, ccwerrboundC;
real_t iccerrboundA, iccerrboundB, iccerrboundC;
real_t o3derrboundA, o3derrboundB, o3derrboundC;
...
/* Other variables. */
  ...
  real_t xmin, xmax, ymin, ymax;                            /* x and y bounds. */
  real_t xminextreme;      /* Nonexistent x value used as a flag in sweepline. */
...
/* Read the instructions to find out the meaning of these switches.          */
  ...
  int nobisect;
  int steiner;
  real_t minangle, goodangle, offconstant;
  real_t maxarea;
...
#define elemattribute(otri, attnum)                                           \
  ((real_t *) (otri).tri)[m->elemattribindex + (attnum)]

#define setelemattribute(otri, attnum, value)                                 \
  ((real_t *) (otri).tri)[m->elemattribindex + (attnum)] = value

/* Check or set a triangle's maximum area bound.                             */

#define areabound(otri)  ((real_t *) (otri).tri)[m->areaboundindex]

#define setareabound(otri, value)                                             \
  ((real_t *) (otri).tri)[m->areaboundindex] = value
...
int triunsuitable(vertex triorg, vertex tridest, vertex triapex, real_t area) {
  real_t dxoa, dxda, dxod;
  real_t dyoa, dyda, dyod;
  real_t oalen, dalen, odlen;
  real_t maxlen;
...
void parsecommandline(int argc, char **argv, struct behavior *b) {
      ...
      for (j = STARTINDEX; argv[i][j] != '\0'; j++) {
        ...
        if (argv[i][j] == 'q') {
          ...
          if (((argv[i][j + 1] >= '0') && (argv[i][j + 1] <= '9')) ||
            ...
            workstring[k] = '\0';
            b->minangle = (real_t) strtod(workstring, (char **) NULL);
	  } else {
            b->minangle = 20.0;
	  }
	}
        if (argv[i][j] == 'a') {
          ...
          if (((argv[i][j + 1] >= '0') && (argv[i][j + 1] <= '9')) ||
            ...
            workstring[k] = '\0';
            b->maxarea = (real_t) strtod(workstring, (char **) NULL);
            if (b->maxarea <= 0.0) {
  ...
  b->goodangle = (real_t)cos(b->minangle * PI / 180.0);
  if (b->goodangle == 1.0) {
    b->offconstant = 0.0;
  } else {
    b->offconstant = (real_t)( 0.475 * sqrt((1.0 + b->goodangle) / (1.0 - b->goodangle)) );
  }
...
void initializevertexpool(struct mesh *m, struct behavior *b)
{
  ...
  m->vertexmarkindex = ((m->mesh_dim + m->nextras) * sizeof(real_t) +
                        sizeof(int) - 1) /
                       sizeof(int);
...
void initializetrisubpools(struct mesh *m, struct behavior *b)
{
  ...
  m->elemattribindex = (trisize + sizeof(real_t) - 1) / sizeof(real_t);
  ...
  if (b->vararea) {
    trisize = (m->areaboundindex + 1) * sizeof(real_t);
  } else if (m->eextras + b->regionattrib > 0) {
    trisize = m->areaboundindex * sizeof(real_t);
  }
...
void exactinit()
{
  ...
  do {
    ...
    check = (real_t)( 1.0 + epsilon );
  } while ((check != 1.0) && (check != lastcheck));
  splitter += 1.0;
  /* Error bounds for orientation and incircle tests. */
  resulterrbound = (real_t)( (3.0 + 8.0 * epsilon) * epsilon );
  ccwerrboundA = (real_t)( (3.0 + 16.0 * epsilon) * epsilon );
  ccwerrboundB = (real_t)( (2.0 + 12.0 * epsilon) * epsilon );
  ccwerrboundC = (real_t)( (9.0 + 64.0 * epsilon) * epsilon * epsilon );
  iccerrboundA = (real_t)( (10.0 + 96.0 * epsilon) * epsilon );
  iccerrboundB = (real_t)( (4.0 + 48.0 * epsilon) * epsilon );
  iccerrboundC = (real_t)( (44.0 + 576.0 * epsilon) * epsilon * epsilon );
  o3derrboundA = (real_t)( (7.0 + 56.0 * epsilon) * epsilon );
  o3derrboundB = (real_t)( (3.0 + 28.0 * epsilon) * epsilon );
  o3derrboundC = (real_t)( (26.0 + 288.0 * epsilon) * epsilon * epsilon );
}
...
int fast_expansion_sum_zeroelim(int elen, real_t *e, int flen, real_t *f, real_t *h)
{
  real_t Q;
  INEXACT real_t Qnew;
  INEXACT real_t hh;
  INEXACT real_t bvirt;
  real_t avirt, bround, around;
...
int scale_expansion_zeroelim(int elen, real_t *e, real_t b, real_t *h)
{
  INEXACT real_t Q, sum;
  real_t hh;
  INEXACT real_t product1;
  real_t product0;
  int eindex, hindex;
  real_t enow;
  INEXACT real_t bvirt;
  ...
  INEXACT real_t c;
  INEXACT real_t abig;
  real_t ahi, alo, bhi, blo;
  real_t err1, err2, err3;
...
real_t estimate(int elen, real_t *e)
{
  real_t Q;
  int eindex;
...
real_t counterclockwiseadapt(vertex pa, vertex pb, vertex pc, real_t detsum)
{
  INEXACT real_t acx, acy, bcx, bcy;
  real_t acxtail, acytail, bcxtail, bcytail;
  INEXACT real_t detleft, detright;
  real_t detlefttail, detrighttail;
  real_t det, errbound;
  real_t B[4], C1[8], C2[12], D[16];
  INEXACT real_t B3;
  int C1length, C2length, Dlength;
  real_t u[4];
  INEXACT real_t u3;
  INEXACT real_t s1, t1;
  real_t s0, t0;
  ...
  real_t ahi, alo, bhi, blo;
  real_t err1, err2, err3;
  INEXACT real_t _i, _j;
  real_t _0;

  acx = (real_t) (pa[0] - pc[0]);
  bcx = (real_t) (pb[0] - pc[0]);
  acy = (real_t) (pa[1] - pc[1]);
  bcy = (real_t) (pb[1] - pc[1]);
...
real_t counterclockwise(struct mesh *m, struct behavior *b,
                      vertex pa, vertex pb, vertex pc)
{
  real_t detleft, detright, det;
  real_t detsum, errbound;
...
real_t incircleadapt(vertex pa, vertex pb, vertex pc, vertex pd, real_t permanent)
{
  INEXACT real_t adx, bdx, cdx, ady, bdy, cdy;
  real_t det, errbound;

  INEXACT real_t bdxcdy1, cdxbdy1, cdxady1, adxcdy1, adxbdy1, bdxady1;
  real_t bdxcdy0, cdxbdy0, cdxady0, adxcdy0, adxbdy0, bdxady0;
  real_t bc[4], ca[4], ab[4];
  INEXACT real_t bc3, ca3, ab3;
  real_t axbc[8], axxbc[16], aybc[8], ayybc[16], adet[32];
  int axbclen, axxbclen, aybclen, ayybclen, alen;
  real_t bxca[8], bxxca[16], byca[8], byyca[16], bdet[32];
  int bxcalen, bxxcalen, bycalen, byycalen, blen;
  real_t cxab[8], cxxab[16], cyab[8], cyyab[16], cdet[32];
  int cxablen, cxxablen, cyablen, cyyablen, clen;
  real_t abdet[64];
  int ablen;
  real_t fin1[1152], fin2[1152];
  real_t *finnow, *finother, *finswap;
  int finlength;

  real_t adxtail, bdxtail, cdxtail, adytail, bdytail, cdytail;
  INEXACT real_t adxadx1, adyady1, bdxbdx1, bdybdy1, cdxcdx1, cdycdy1;
  real_t adxadx0, adyady0, bdxbdx0, bdybdy0, cdxcdx0, cdycdy0;
  real_t aa[4], bb[4], cc[4];
  INEXACT real_t aa3, bb3, cc3;
  INEXACT real_t ti1, tj1;
  real_t ti0, tj0;
  real_t u[4], v[4];
  INEXACT real_t u3, v3;
  real_t temp8[8], temp16a[16], temp16b[16], temp16c[16];
  real_t temp32a[32], temp32b[32], temp48[48], temp64[64];
  int temp8len, temp16alen, temp16blen, temp16clen;
  int temp32alen, temp32blen, temp48len, temp64len;
  real_t axtbb[8], axtcc[8], aytbb[8], aytcc[8];
  int axtbblen, axtcclen, aytbblen, aytcclen;
  real_t bxtaa[8], bxtcc[8], bytaa[8], bytcc[8];
  int bxtaalen, bxtcclen, bytaalen, bytcclen;
  real_t cxtaa[8], cxtbb[8], cytaa[8], cytbb[8];
  int cxtaalen, cxtbblen, cytaalen, cytbblen;
  real_t axtbc[8], aytbc[8], bxtca[8], bytca[8], cxtab[8], cytab[8];
  int axtbclen, aytbclen, bxtcalen, bytcalen, cxtablen, cytablen;
  real_t axtbct[16], aytbct[16], bxtcat[16], bytcat[16], cxtabt[16], cytabt[16];
  int axtbctlen, aytbctlen, bxtcatlen, bytcatlen, cxtabtlen, cytabtlen;
  real_t axtbctt[8], aytbctt[8], bxtcatt[8];
  real_t bytcatt[8], cxtabtt[8], cytabtt[8];
  int axtbcttlen, aytbcttlen, bxtcattlen, bytcattlen, cxtabttlen, cytabttlen;
  real_t abt[8], bct[8], cat[8];
  int abtlen, bctlen, catlen;
  real_t abtt[4], bctt[4], catt[4];
  int abttlen, bcttlen, cattlen;
  INEXACT real_t abtt3, bctt3, catt3;
  real_t negate;
  ...
  adx = (real_t) (pa[0] - pd[0]);
  bdx = (real_t) (pb[0] - pd[0]);
  cdx = (real_t) (pc[0] - pd[0]);
  ady = (real_t) (pa[1] - pd[1]);
  bdy = (real_t) (pb[1] - pd[1]);
  cdy = (real_t) (pc[1] - pd[1]);
  ...
  det += (real_t)( ((adx * adx + ady * ady) * ((bdx * cdytail + cdy * bdxtail)
  ...
  if (adxtail != 0.0) {
    ...
    temp16alen = scale_expansion_zeroelim(axtbclen, axtbc, (real_t)( 2.0 * adx ), temp16a);
  ...
  if (adytail != 0.0) {
    ...
    temp16alen = scale_expansion_zeroelim(aytbclen, aytbc, (real_t)( 2.0 * ady ), temp16a);
  ...
  if (bdxtail != 0.0) {
    ...
    temp16alen = scale_expansion_zeroelim(bxtcalen, bxtca, (real_t)( 2.0 * bdx ), temp16a);
  ...
  if (bdytail != 0.0) {
    ...
    temp16alen = scale_expansion_zeroelim(bytcalen, bytca, (real_t)( 2.0 * bdy ), temp16a);
  ...
  if (cdxtail != 0.0) {
    ...
    temp16alen = scale_expansion_zeroelim(cxtablen, cxtab, (real_t)( 2.0 * cdx ), temp16a);
  ...
  if (cdytail != 0.0) {
    ...
    temp16alen = scale_expansion_zeroelim(cytablen, cytab, (real_t)( 2.0 * cdy), temp16a);
  ...
  if ((adxtail != 0.0) || (adytail != 0.0)) {
    ...
    if (adxtail != 0.0) {
      ...
      temp32alen = scale_expansion_zeroelim(axtbctlen, axtbct, (real_t)( 2.0 * adx ),
                                            temp32a);
      ...
      temp16alen = scale_expansion_zeroelim(axtbcttlen, axtbctt, (real_t)( 2.0 * adx ),
                                            temp16a);
    ...
    if (adytail != 0.0) {
      ...
      temp32alen = scale_expansion_zeroelim(aytbctlen, aytbct, (real_t)( 2.0 * ady ),
                                            temp32a);
      temp48len = fast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp32alen, temp32a, temp48);
      finlength = fast_expansion_sum_zeroelim(finlength, finnow, temp48len,
      ...
      temp16alen = scale_expansion_zeroelim(aytbcttlen, aytbctt, (real_t)( 2.0 * ady ),
                                            temp16a);
  ...
  if ((bdxtail != 0.0) || (bdytail != 0.0)) {
    ...
    if (bdxtail != 0.0) {
      ...
      temp32alen = scale_expansion_zeroelim(bxtcatlen, bxtcat, (real_t)( 2.0 * bdx ),
                                            temp32a);
      temp48len = fast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp32alen, temp32a, temp48);
      finlength = fast_expansion_sum_zeroelim(finlength, finnow, temp48len,
      ...
      temp16alen = scale_expansion_zeroelim(bxtcattlen, bxtcatt, (real_t)( 2.0 * bdx ),
                                            temp16a);
    ...
    if (bdytail != 0.0) {
      ...
      temp32alen = scale_expansion_zeroelim(bytcatlen, bytcat, (real_t)( 2.0 * bdy ),
                                            temp32a);
      temp48len = fast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp32alen, temp32a, temp48);
      finlength = fast_expansion_sum_zeroelim(finlength, finnow, temp48len,
      ...
      temp16alen = scale_expansion_zeroelim(bytcattlen, bytcatt, (real_t)( 2.0 * bdy ),
                                            temp16a);
  ...
  if ((cdxtail != 0.0) || (cdytail != 0.0)) {
    ...
    if (cdxtail != 0.0) {
      ...
      temp32alen = scale_expansion_zeroelim(cxtabtlen, cxtabt, (real_t)( 2.0 * cdx ),
                                            temp32a);
      temp48len = fast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp32alen, temp32a, temp48);
      finlength = fast_expansion_sum_zeroelim(finlength, finnow, temp48len,
      ...
      temp16alen = scale_expansion_zeroelim(cxtabttlen, cxtabtt, (real_t)( 2.0 * cdx ),
                                            temp16a);
    ...
    if (cdytail != 0.0) {
      ...
      temp32alen = scale_expansion_zeroelim(cytabtlen, cytabt, (real_t)( 2.0 * cdy ),
                                            temp32a);
      temp48len = fast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp32alen, temp32a, temp48);
      finlength = fast_expansion_sum_zeroelim(finlength, finnow, temp48len,
      ...
      temp16alen = scale_expansion_zeroelim(cytabttlen, cytabtt, (real_t)( 2.0 * cdy ),
                                            temp16a);
...
real_t incircle(struct mesh *m, struct behavior *b,
              vertex pa, vertex pb, vertex pc, vertex pd)
{
  real_t adx, bdx, cdx, ady, bdy, cdy;
  real_t bdxcdy, cdxbdy, cdxady, adxcdy, adxbdy, bdxady;
  real_t alift, blift, clift;
  real_t det;
  real_t permanent, errbound;
...
real_t orient3dadapt(vertex pa, vertex pb, vertex pc, vertex pd,
                   real_t aheight, real_t bheight, real_t cheight, real_t dheight,
                   real_t permanent)
{
  INEXACT real_t adx, bdx, cdx, ady, bdy, cdy, adheight, bdheight, cdheight;
  real_t det, errbound;
  ...
  real_t bc[4], ca[4], ab[4];
  INEXACT real_t bc3, ca3, ab3;
  real_t adet[8], bdet[8], cdet[8];
  int alen, blen, clen;
  real_t abdet[16];
  int ablen;
  real_t *finnow, *finother, *finswap;
  real_t fin1[192], fin2[192];
  int finlength;

  real_t adxtail, bdxtail, cdxtail;
  real_t adytail, bdytail, cdytail;
  real_t adheighttail, bdheighttail, cdheighttail;
  INEXACT real_t at_blarge, at_clarge;
  INEXACT real_t bt_clarge, bt_alarge;
  INEXACT real_t ct_alarge, ct_blarge;
  real_t at_b[4], at_c[4], bt_c[4], bt_a[4], ct_a[4], ct_b[4];
  int at_blen, at_clen, bt_clen, bt_alen, ct_alen, ct_blen;
  INEXACT real_t bdxt_cdy1, cdxt_bdy1, cdxt_ady1;
  INEXACT real_t adxt_cdy1, adxt_bdy1, bdxt_ady1;
  real_t bdxt_cdy0, cdxt_bdy0, cdxt_ady0;
  real_t adxt_cdy0, adxt_bdy0, bdxt_ady0;
  INEXACT real_t bdyt_cdx1, cdyt_bdx1, cdyt_adx1;
  INEXACT real_t adyt_cdx1, adyt_bdx1, bdyt_adx1;
  real_t bdyt_cdx0, cdyt_bdx0, cdyt_adx0;
  real_t adyt_cdx0, adyt_bdx0, bdyt_adx0;
  real_t bct[8], cat[8], abt[8];
  int bctlen, catlen, abtlen;
  INEXACT real_t bdxt_cdyt1, cdxt_bdyt1, cdxt_adyt1;
  INEXACT real_t adxt_cdyt1, adxt_bdyt1, bdxt_adyt1;
  real_t bdxt_cdyt0, cdxt_bdyt0, cdxt_adyt0;
  real_t adxt_cdyt0, adxt_bdyt0, bdxt_adyt0;
  real_t u[4], v[12], w[16];
  INEXACT real_t u3;
  int vlength, wlength;
  real_t negate;
  ...
  bdy = (real_t) (pb[1] - pd[1]);
  cdy = (real_t) (pc[1] - pd[1]);
  adheight = (real_t) (aheight - dheight);
  bdheight = (real_t) (bheight - dheight);
  cdheight = (real_t) (cheight - dheight);
...
real_t orient3d(struct mesh *m, struct behavior *b,
              vertex pa, vertex pb, vertex pc, vertex pd,
              real_t aheight, real_t bheight, real_t cheight, real_t dheight)
{
  real_t adx, bdx, cdx, ady, bdy, cdy, adheight, bdheight, cdheight;
  real_t bdxcdy, cdxbdy, cdxady, adxcdy, adxbdy, bdxady;
  real_t det;
  real_t permanent, errbound;
...
real_t nonregular(struct mesh *m, struct behavior *b,
                vertex pa, vertex pb, vertex pc, vertex pd)
{
  if (b->weighted == 0) {
...
void findcircumcenter(struct mesh *m, struct behavior *b,
                      ...
                      vertex circumcenter, real_t *xi, real_t *eta, int offcenter)
{
  real_t xdo, ydo, xao, yao;
  real_t dodist, aodist, dadist;
  real_t denominator;
  real_t dx, dy, dxoff, dyoff;
  ...
  if (b->noexact) {
    denominator = (real_t)( 0.5 / (xdo * yao - xao * ydo) );
  } else {
    /* Use the counterclockwise() routine to ensure a positive (and */
    /*   reasonably accurate) result, avoiding any possibility of   */
    /*   division by zero.                                          */
    denominator = (real_t)( 0.5 / counterclockwise(m, b, tdest, tapex, torg) );
  ...
  if ((dodist < aodist) && (dodist < dadist)) {
    if (offcenter && (b->offconstant > 0.0)) {
      ...
      dxoff = (real_t)( 0.5 * xdo - b->offconstant * ydo );
      dyoff = (real_t)( 0.5 * ydo + b->offconstant * xdo );
    ...
    if (offcenter && (b->offconstant > 0.0)) {
      dxoff = (real_t)( 0.5 * xao + b->offconstant * yao );
      dyoff = (real_t)( 0.5 * yao - b->offconstant * xao );
      /* If the off-center is closer to the origin than the */
      /*   circumcenter, use the off-center instead.        */
      if (dxoff * dxoff + dyoff * dyoff < dx * dx + dy * dy) {
        dx = dxoff;
    ...
    if (offcenter && (b->offconstant > 0.0)) {
      dxoff = (real_t)( 0.5 * (tapex[0] - tdest[0]) -
              b->offconstant * (tapex[1] - tdest[1]) );
      dyoff = (real_t)( 0.5 * (tapex[1] - tdest[1]) +
  ...
  *xi = (real_t)( (yao * dx - xao * dy) * (2.0 * denominator) );
  *eta = (real_t)( (xdo * dy - ydo * dx) * (2.0 * denominator) );
}
...
void enqueuebadtri(struct mesh *m, struct behavior *b, struct otri *enqtri,
                   real_t minedge, vertex enqapex, vertex enqorg, vertex enqdest)
{
...
void testtriangle(struct mesh *m, struct behavior *b, struct otri *testtri) {
  ...
  vertex joinvertex;
  real_t dxod, dyod, dxda, dyda, dxao, dyao;
  real_t dxod2, dyod2, dxda2, dyda2, dxao2, dyao2;
  real_t apexlen, orglen, destlen, minedge;
  real_t angle;
  real_t area;
  real_t dist1, dist2;
  subseg sptr;                      /* Temporary variable used by tspivot(). */
  ...
  if (b->vararea || b->fixedarea || b->usertest) {
    ...
    area = (real_t)( 0.5 * (dxod * dyda - dyod * dxda) );
      ...
      if (top.tri == m->dummytri) {
        ...
        if (doflip) {
          ...
          for (i = 0; i < m->eextras; i++) {
            ...
            attrib = (real_t)( 0.5 * (elemattribute(top, i) + elemattribute(horiz, i)) );
          ...
          if (b->vararea) {
            if ((areabound(top) <= 0.0) || (areabound(horiz) <= 0.0)) {
              ...
              area = (real_t)( 0.5 * (areabound(top) + areabound(horiz)) );
            }
...
void boundingbox(struct mesh *m, struct behavior *b)
{
  ...
  m->infvertex1[0] = (real_t)( m->xmin - 50.0 * width );
  m->infvertex1[1] = (real_t)( m->ymin - 40.0 * width );
  m->infvertex2[0] = (real_t)( m->xmax + 50.0 * width );
  m->infvertex2[1] = (real_t)( m->ymin - 40.0 * width );
  m->infvertex3[0] = (real_t)( 0.5 * (m->xmin + m->xmax) );
  m->infvertex3[1] = (real_t)( m->ymax + 60.0 * width );
...
real_t circletop(struct mesh *m, vertex pa, vertex pb, vertex pc, real_t ccwabc)
{
  real_t xac, yac, xbc, ybc, xab, yab;
  real_t aclen2, bclen2, ablen2;
  ...
  return (real_t)( pc[1] + (xac * bclen2 - xbc * aclen2 + sqrt(aclen2 * bclen2 * ablen2))
               / (2.0 * ccwabc) );
}
...
struct splaynode *circletopinsert(struct mesh *m, struct behavior *b,
                                  ...
                                  struct otri *newkey,
                                  vertex pa, vertex pb, vertex pc, real_t topy)
{
  real_t ccwabc;
  real_t xac, yac, xbc, ybc;
  real_t aclen2, bclen2;
  real_t searchpoint[2];
  ...
  aclen2 = xac * xac + yac * yac;
  bclen2 = xbc * xbc + ybc * ybc;
  searchpoint[0] = (real_t)( pc[0] - (yac * bclen2 - ybc * aclen2) / (2.0 * ccwabc) );
  searchpoint[1] = topy;
...
int reconstruct(struct mesh *m, struct behavior *b, int *trianglelist,
                real_t *triangleattriblist, real_t *trianglearealist,
  ...
  while (triangleloop.tri != (triangle *) NULL) {
    ...
    for (j = 0; j < m->eextras; j++) {
      ...
      if (*stringptr == '\0') {
        ...
        setelemattribute(triangleloop, j,
                         (real_t) strtod(stringptr, &stringptr));
      }
#endif /* not TRILIBRARY */
    }
    ...
    if (b->vararea) {
      ...
      if (*stringptr == '\0') {
        ...
        area = (real_t) strtod(stringptr, &stringptr);
      }
#endif /* not TRILIBRARY */
                    ...
                    vertex endpoint1, vertex endpoint2, int newmark)
{
  ...
  for (i = 0; i < 2 + m->nextras; i++) {
    newvertex[i] = (real_t)( 0.5 * (endpoint1[i] + endpoint2[i]) );
  }
...
void carveholes(struct mesh *m, struct behavior *b, real_t *holelist, int holes,
                real_t *regionlist, int regions)
{
  struct otri searchtri;
  struct otri triangleloop;
...
void splitencsegs(struct mesh *m, struct behavior *b, int triflaws)
{
  ...
  vertex newvertex;
  enum insertvertexresult success;
  real_t segmentlength, nearestpoweroftwo;
  real_t split;
  real_t multiplier, divisor;
  ...
  while (triangleloop.tri != (triangle *) NULL) {
    for (triangleloop.orient = 0; triangleloop.orient < 3;
      ...
      if ((triangleloop.tri < trisym.tri) || (trisym.tri == m->dummytri)) {
        ...
        newvertex = (vertex) poolalloc(&m->vertices);
        for (i = 0; i < 2 + m->nextras; i++) {
          newvertex[i] = (real_t)( 0.5 * (torg[i] + tdest[i]) );
        }
               ...
               char *polyfilename, FILE **polyfile)
{
  ...
  for (i = 0; i < m->invertices; i++) {
    ...
    x = (real_t) strtod(stringptr, &stringptr);
    stringptr = findfield(stringptr);
    if (*stringptr == '\0') {
      printf("Error:  Vertex %d has no y coordinate.\n", b->firstnumber + i);
      triexit(1);
    }
    y = (real_t) strtod(stringptr, &stringptr);
    vertexloop[0] = x;
    vertexloop[1] = y;
    ...
    for (j = 2; j < 2 + m->nextras; j++) {
      ...
      if (*stringptr == '\0') {
        ...
        vertexloop[j] = (real_t) strtod(stringptr, &stringptr);
      }
    }
    if (nodemarkers) {
...
void transfernodes(struct mesh *m, struct behavior *b, real_t *pointlist,
                   real_t *pointattriblist, int *pointmarkerlist,
...
void readholes(struct mesh *m, struct behavior *b,
               FILE *polyfile, char *polyfilename, real_t **hlist, int *holes,
               real_t **rlist, int *regions)
{
  real_t *holelist;
  real_t *regionlist;
  char inputline[INPUTLINESIZE];
  ...
  *holes = (int) strtol(stringptr, &stringptr, 0);
  if (*holes > 0) {
    holelist = (real_t *) trimalloc(2 * *holes * (int) sizeof(real_t));
    *hlist = holelist;
    for (i = 0; i < 2 * *holes; i += 2) {
      stringptr = readline(inputline, polyfile, polyfilename);
      stringptr = findfield(stringptr);
      if (*stringptr == '\0') {
        ...
        holelist[i] = (real_t) strtod(stringptr, &stringptr);
      }
      stringptr = findfield(stringptr);
      if (*stringptr == '\0') {
        ...
        holelist[i + 1] = (real_t) strtod(stringptr, &stringptr);
      }
    }
  } else {
    *hlist = (real_t *) NULL;
  ...
  if ((b->regionattrib || b->vararea) && !b->refine) {
    ...
    *regions = (int) strtol(stringptr, &stringptr, 0);
    if (*regions > 0) {
      regionlist = (real_t *) trimalloc(4 * *regions * (int) sizeof(real_t));
      *rlist = regionlist;
      index = 0;
      for (i = 0; i < *regions; i++) {
        stringptr = readline(inputline, polyfile, polyfilename);
        ...
        if (*stringptr == '\0') {
          ...
          regionlist[index++] = (real_t) strtod(stringptr, &stringptr);
        }
        stringptr = findfield(stringptr);
        if (*stringptr == '\0') {
...
void writenodes(struct mesh *m, struct behavior *b, real_t **pointlist,
                real_t **pointattriblist, int **pointmarkerlist)
#else /* not TRILIBRARY */
...

{
  ...
  if (*pointlist == (real_t *) NULL) {
    *pointlist = (real_t *) trimalloc((int) (outvertices * 2 * sizeof(real_t)));
  }
  /* Allocate memory for output vertex attributes if necessary. */
  if ((m->nextras > 0) && (*pointattriblist == (real_t *) NULL)) {
    *pointattriblist = (real_t *) trimalloc((int) (outvertices * m->nextras *
                                                 sizeof(real_t)));
  }
...
void writeelements(struct mesh *m, struct behavior *b,
                   int **trianglelist, real_t **triangleattriblist)
#else /* not TRILIBRARY */
...

{
  ...
  if ((m->eextras > 0) && (*triangleattriblist == (real_t *) NULL)) {
    *triangleattriblist = (real_t *) trimalloc((int) (m->triangles.items *
                                                    m->eextras *
                                                    sizeof(real_t)));
  }
  tlist = *trianglelist;
...
void writepoly(struct mesh *m, struct behavior *b, char *polyfilename,
               real_t *holelist, int holes, real_t *regionlist, int regions,
               int argc, char **argv)
#endif /* not TRILIBRARY */
...
void writevoronoi(struct mesh *m, struct behavior *b, real_t **vpointlist,
                  real_t **vpointattriblist, int **vpointmarkerlist,
                  int **vedgelist, int **vedgemarkerlist, real_t **vnormlist)
#else /* not TRILIBRARY */
...

{
  ...
  if (*vpointlist == (real_t *) NULL) {
    *vpointlist = (real_t *) trimalloc((int) (m->triangles.items * 2 *
                                            sizeof(real_t)));
  }
  /* Allocate memory for Voronoi vertex attributes if necessary. */
  if (*vpointattriblist == (real_t *) NULL) {
    *vpointattriblist = (real_t *) trimalloc((int) (m->triangles.items *
                                                  m->nextras * sizeof(real_t)));
  }
  ...
  *vedgemarkerlist = (int *) NULL;
  ...
  if (*vnormlist == (real_t *) NULL) {
    *vnormlist = (real_t *) trimalloc((int) (m->edges * 2 * sizeof(real_t)));
  }
  elist = *vedgelist;
  normlist = *vnormlist;
  coordindex = 0;
...
void quality_statistics(struct mesh *m, struct behavior *b)
{
  struct otri triangleloop;
  vertex p[3];
  real_t cossquaretable[8];
  real_t ratiotable[16];
  real_t dx[3], dy[3];
  real_t edgelength[3];
  real_t dotproduct;
  real_t cossquare;
  real_t triarea;
  real_t shortest, longest;
  real_t trilongest2;
  real_t smallestarea, biggestarea;
  real_t triminaltitude2;
  real_t minaltitude;
  real_t triaspect2;
  real_t worstaspect;
  real_t smallestangle, biggestangle;
  real_t radconst, degconst;
  int angletable[18];
  int aspecttable[16];
  int aspectindex;
  int tendegree;
  ...
  radconst = (real_t)( PI / 18.0 );
  degconst = (real_t)( 180.0 / PI );
  for (i = 0; i < 8; i++) {
    cossquaretable[i] = cos(radconst * (real_t) (i + 1));
  ...
  if (biggestangle >= 1.0) {
    ...
    if (acutebiggest) {
      ...
      biggestangle = (real_t)( 180.0 - degconst * acos(sqrt(biggestangle)) );
    }
  }
...

{
  struct mesh m;
  struct behavior b;
  real_t *holearray;                                        /* Array of holes. */
  real_t *regionarray;   /* Array of regional attributes and area constraints. */
#ifndef TRILIBRARY
  FILE *polyfile;
#endif /* not TRILIBRARY */
#ifndef NO_TIMER
  ...
  if (b.poly || b.convex) {
    ...
    if (b.nopolywritten || b.noiterationnum) {
      ...
      if (b.poly) {
        ...
        out->holelist = (real_t *) NULL;
        out->regionlist = (real_t *) NULL;
      }
#else /* not TRILIBRARY */
